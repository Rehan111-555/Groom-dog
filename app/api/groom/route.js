...
export async function POST(req) {
  try {
    ...
    const hardRules = [
      ...
      (targetW && targetH) ? `The output MUST be exactly ${targetW}x${targetH} pixels. Do not change aspect ratio or resolution.` : null,
    ...
    const errText = parts.find((p)=>p?.text)?.text || "Model returned no image.";
