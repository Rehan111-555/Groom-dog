        ...
        <Card className="p-4">
          ...
          <div className="mt-3">
            ...
            <div className="mt-1 flex gap-2">
              <input
                value={imageURL}
                onChange={(e)=>{ setImageURL(e.target.value); if(e.target.value) setFileThumb(null); }}
                placeholder="https://…"
          ...
          <div className="mt-5">
            ...
            <input
              ...
              className="mt-1 w-full h-10 rounded-md bg-[#0b0e13] border border-white/10 px-3 outline-none text-sm"
          ...
          <details className="mt-5 group">
            ...
            <div className="mt-3 grid grid-cols-2 gap-3 text-sm">
              <div>
                ...
                <input type="number" min={0} max={1} step={0.05} defaultValue={0.4}
            ...
            <p className="mt-3 text-[11px] text-slate-400">Customize your input with more control.</p>
          </details>

          {/* Actions */}
          <div className="mt-6 flex items-center justify-between">
            <Button onClick={()=>{
              setImageURL(''); setFileThumb(null); setPrompt('Speed limit'); setJsonText(''); setResultImage('');
            }}>
              <I.Reset /> Reset
            </Button>
