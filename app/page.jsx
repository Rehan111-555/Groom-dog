...
/* =========================================================
   Upload + Result (local file OR URL + small thumbnail)
   ========================================================= */
  ...
  return (
    <header className="w-full z-50">
      ...
      <div className="sticky top-0">
        ...
        {/* 1 inch gap with SAME color as header */}
        <div className={`${topBarClass} h-[1in]`} aria-hidden="true" />
