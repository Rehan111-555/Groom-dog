...
/* =========================================================
   Upload + Result (now supports URL paste + small thumb)
   ========================================================= */
function UploadAndResult(){
  ...
  const handleUrlLoad = async () => {
    ...
    if (!u) return;
    setError(null);
    setFile(null); // using URL input path
    setResultUrl(null);
    setPreviewUrl(u);
  ...
  const groom=async()=>{
    if(!file && !previewUrl) return; // need something
    ...
    try{
      ...
      if (file) {
        ...
        form.append("image_url", previewUrl); // backend can accept this if implemented
      }
    ...
    <section id="app" className="container mx-auto px-6 py-16">
      ...
      <div className="grid lg:grid-cols-2 gap-8 items-stretch">
        ...
        <Card className="p-4">
          ...
          {/* URL paste row (simple, no extra “More/Additional settings”) */}
          <div className="flex items-stretch gap-2 mb-3">
            <input
              ...
              className="flex-1 min-w-0 px-3 py-2 rounded-md ring-1 ring-[var(--app-border)] bg-[var(--app-surface)] outline-none"
            />
          ...
          <div className="rounded-2xl border border-dashed border-slate-300 dark:border-[var(--app-border)] bg-[var(--app-surface)]" style={{ height: panelH, position:'relative' }}>
            ...
            {/* Small thumbnail (like your SS3) — always anchored top-left */}
            {hasInput && (
        ...
        <div className="max-w-[1280px] mx-auto px-4 lg:px-6 h-[72px] grid grid-cols-[1fr_auto_1fr] items-center">
          ...
          <div className="justify-self-end flex items-center gap-4">
            <div className="relative hidden md:block">
              ...
              <button
                className="search-btn absolute right-[8px] top-1/2 -translate-y-1/2 h-[32px] w-[32px] grid place-items-center rounded-full"
                aria-label="Search"
              >
                <Icon.Search />
              </button>
            ...
            <div className="absolute left-1/2 -translate-x-1/2 top-full pt-[8px]" onMouseEnter={()=>setOpen(open)}>
              <div className="jz-mega w-[calc(100vw-32px)] max-w-[1280px]">
                ...
                <div className="relative grid grid-cols-3 gap-14 p-8">
                  ...
                  {/* keep your previous sections here */}
                </div>
              </div>
            </div>
          )}
...
function SigninFooter() {
  return (
    <footer className="bg-[#4a4a4a] text-slate-100">
      <FooterPromoRibbon />
      {/* ... footer content unchanged from your version ... */}
    </footer>
  );
}
  ...
  return (
    <main>
      ...
      <style jsx global>{`
        ...
        .jz-item:hover { color:inherit; } /* no hover color change */
        ...
        .jz-underline, .jz-pointer { opacity:0; } /* keep clean, no underline pointer hover */
        ...
        /* search + toggle colors (fix "still light" in dark) */
        ...
        .theme-dark .search-btn { background: var(--app-surface); border:1px solid var(--app-border); }
        ...
        .icon-btn:hover{ background: transparent; } /* no hover color */

        /* dark corrections inside app */
        .theme-dark .bg-white,
