      ...
      <div className="grid md:grid-cols-3 gap-6 items-stretch">
        <Card className="p-6 flex flex-col min-h-[220px]">
          ...
          <div className="mt-auto pt-4">
            <a href="#app" className="btn btn-charcoal inline-flex w-[140px] justify-center">Upload now</a>
          </div>
        </Card>
        <Card className="p-6 flex flex-col min-h-[220px]">
          ...
          <div className="mt-auto pt-4">
            <a href="#app" className="btn btn-charcoal inline-flex w-[140px] justify-center">Start grooming</a>
          </div>
        </Card>
        <Card className="p-6 flex flex-col min-h-[220px]">
          ...
          <div className="mt-auto pt-4">
            <a href="#app" className="btn btn-charcoal inline-flex w-[140px] justify-center">Try the slider</a>
          </div>
        </Card>
      </div>
    </section>
